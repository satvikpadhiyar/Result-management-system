...
$status=1;
$sql="DELETE FROM tblsubjects WHERE id=:delete";
$query = $dbh->prepare($sql);
$query->bindParam(':delete',$delete,PDO::PARAM_STR);
$query->execute();
...
&nbsp;
<a href="manage-subjects.php?delete=<?php echo htmlentities($result->id);?>" ><i class="fa fa-times" title="Deactivate Record"></i> </a>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
